    ...
    return (
        ...
        >
                ...
                <div>
                    <ul>
                        <li style={{display: "flex", alignItems: "center", marginBottom: "5px"}}>
                            ...
                            <input style={{ width: "70px", height: "30px", boxSizing: "border-box", border: "1px solid #D9D9D9", borderRadius: "4px"}} type="text"/>
                            <input style={{ width: "70px", height: "30px", boxSizing: "border-box", border: "1px solid #D9D9D9", borderRadius: "4px"}} type="text"/>
                            <span style={{marginLeft: "10px" , marginRight: "10px"}}>-</span>
                            <input style={{ marginRight: "5px" ,width: "70px", height: "30px", boxSizing: "border-box", border: "1px solid #D9D9D9", borderRadius: "4px"}} type="text"/>
                            <input style={{ width: "70px", height: "30px", boxSizing: "border-box", border: "1px solid #D9D9D9", borderRadius: "4px"}} type="text"/>
                        </li>
                    </ul>
                </div>
            ...
            <div className="clearfix">
                ...
                <h1>Images <span style={{color: "grey"}}>(maximum 4)</span></h1>
                <Upload
